# toPrint/ — your card library (never committed)
...
```sh
python -m lotrautofill sets      # lists every set in toPrint/
python -m lotrautofill pick      # choose set(s) -> builds/<set>.order.xml
```
